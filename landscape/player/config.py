...
class PlaybackConfiguration(Configuration):
    """Specialized configuration for the Landscape Player.
    ...
    def __init__(self):
        super(PlaybackConfiguration, self).__init__()
    ...
    def make_parser(self):
        ...
        @return: An L{OptionParser} preset for all the options
            from L{Configuration.make_parser} plus:
              ...
              - C{record}
        """
        parser = super(PlaybackConfiguration, self).make_parser()
    ...
    def load(self, args, accept_nonexistent_config=False):
        ...
        that config data.
        """
        super(PlaybackConfiguration, self).load(
