...
class RebootRequiredTest(LandscapeTest):
    ...
    def test_wb_get_packages(self):
        ...
        self.makeFile(
            path=self.reboot_required_filename + ".pkgs",
            content="foo\nbar\n",
        )
    ...
    def test_wb_create_message(self):
        ...
        self.makeFile(path=self.reboot_required_filename, content="")
        self.assertEqual({"flag": True}, self.plugin._create_message())
        self.makeFile(
            path=self.reboot_required_filename + ".pkgs",
            content="foo\n",
        )
        self.assertEqual({"packages": ["foo"]}, self.plugin._create_message())
