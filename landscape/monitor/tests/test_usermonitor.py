...
from landscape.monitor.usermonitor import (
    UserMonitor, UserMonitorDBusObject, RemoteUserMonitorCreator)
from landscape.manager.usermanager import (
    UserManagerDBusObject, UserManager, UserManagerProtocol)
...
class AmpUserMonitorNoManagerTest(LandscapeTest):
...
class AmpUserMonitorTest(LandscapeTest):
    ...
    def setUp(self):
        ...
        def register_plugin(ignored):
            ...
            factory = MethodCallFactory(reactor, self.user_manager)
            factory.protocol = UserManagerProtocol
        ...
        super_setup = super(AmpUserMonitorTest, self).setUp()
    ...
    def tearDown(self):
        ...
        return super(AmpUserMonitorTest, self).tearDown()
