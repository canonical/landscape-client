...
class MechanismTest(LandscapeTest):
    ...
    try:
        ...
        skip_string = "Cannot create private DBus session without X11"
        test_set_https_proxy.skip = skip_string
        test_get_https_proxy.skip = skip_string
        test_set_computer_title.skip = skip_string
        test_get_computer_title.skip = skip_string
        test_set_registration_password.skip = skip_string
        test_get_registration_password.skip = skip_string
        test_set_ping_url.skip = skip_string
        test_get_ping_url.skip = skip_string
        test_set_url.skip = skip_string
        test_get_url.skip = skip_string
        test_set_tags.skip = skip_string
        test_get_tags.skip = skip_string
        test_set_http_proxy.skip = skip_string
        test_get_http_proxy.skip = skip_string
        set_data_path.skip = skip_string
        test_get_data_path.skip = skip_string
        test_set_account_name.skip = skip_string
        test_get_account_name.skip = skip_string
        test_is_local_call.skip = skip_string
